...
export default class EditPostContent extends React.Component<PostProps, PostState> {
    constructor(props) {
        super(props);
    ...
    async handleSubmit(e) {
        ...
        const response = await this.props.itemsContainer.updateItem(this.props.mondayContainer.state.board?.id, this.state.groupId, this.props.itemId, this.state.description);

        this.props.history.push(`/category/${this.state.groupId}/posts/${this.props.itemId}`)
        ...
        return (<PageContainer>
            ...
            <CardView>
                <form className={containerStyle} onSubmit={this.handleSubmit.bind(this)}>
                    ...
                    <input type="text" value={this.state.title} onChange={this.handleTitleChange.bind(this)} placeholder="Give your post a title" disabled />
